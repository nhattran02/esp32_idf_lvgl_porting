...
*/
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_PWCTRL1, (uint8_t[]) {
        0x23,
    }, 1), TAG, "send command failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_PWCTRL2, (uint8_t[]) {
        0x10,
    }, 1), TAG, "send command failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_VMCTRL1, (uint8_t[]) {
        0x3E, 0x28,
    }, 2), TAG, "send command failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_VMCTRL2, (uint8_t[]) {
        0x86,
    }, 1), TAG, "send command failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_MADCTL, (uint8_t[]) {
        0x00, /* 0x08 */
    }, 1), TAG, "send command failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_PIXSET, (uint8_t[]) {
        0x55,
    }, 1), TAG, "send command failed");
    // ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_DINVOFF, NULL, 0), TAG, "send command failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_DINVON, NULL, 0), TAG, "send command failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_FRMCTR1, (uint8_t[]) {
        0x00, 0x18,
    }, 2), TAG, "send command failed");
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_DISCTRL, (uint8_t[]) {
        0x08, 0xA2, 0x27, 0x00, 
    }, 4), TAG, "send command failed");    
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_GAMSET, (uint8_t[]) {
        0x01, 
    }, 1), TAG, "send command failed");  
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_PGAMCTRL, (uint8_t[]) {
        0x0F, 0x31, 0x2B, 0x0C, 0x0E, 0x08, 0x4E, 0xF1, 0x37, 0x07, 0x10, 0x03, 0x0E, 0x09, 0x00, 
    }, 15), TAG, "send command failed");     
    ESP_RETURN_ON_ERROR(esp_lcd_panel_io_tx_param(io, LCD_CMD_NGAMCTRL, (uint8_t[]) {
